...
| `overview-connections.png` | **how it all connects** — `index.md` + top of `labs/README.md` (readable platform map) |
| `overview-platform.png` | optional/superseded — dense all-labs map; prefer `overview-connections.png` |
